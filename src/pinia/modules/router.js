import { asyncRouterHandle } from '@/utils/common/asyncRouter'
import { emitter } from '@/utils/common/bus.js'
import { Api_Common_Menu_AsyncMenu } from '@/api/common/menu'
...
export const useRouterStore = defineStore('router', () => {
    ...
    const SetAsyncRouter = async () => {
        ...
        const asyncRouterRes = await Api_Common_Menu_AsyncMenu()
