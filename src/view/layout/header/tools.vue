...
<!--
        <el-tooltip class="" effect="dark" content="搜索" placement="bottom">
            <el-icon
                @click="handleCommand"
                class="w-8 h-8 shadow rounded-full border cursor-pointer border-solid"
            >
                <Search />
            </el-icon>
        </el-tooltip>
...
<!--        <el-tooltip class="" effect="dark" content="系统设置" placement="bottom">
        ...
        <gui-setting v-model:drawer="showSettingDrawer"></gui-setting>
...
<script setup>
    ...
    import GuiSetting from '@/view/layout/setting/index.vue'
    import { ref } from 'vue'
    import { emitter } from '@/utils/common/bus.js'
    import CommandMenu from '@/components/GuiCommandMenu/index.vue'
    import ToolScreenFull from '@/view/layout/screenfull/index.vue'
