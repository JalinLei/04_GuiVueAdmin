<template>
    <div class="vvh h-full">
        <div v-if="mode === 'head'" class="vvh mx-2 flex items-center w-[calc(100vw-600px)] overflow-auto">
            <el-menu
                :default-active="routerStore.topActive"
                mode="horizontal"
                class="vvh border-r-0 border-b-0 w-full flex items-center box-border"
                unique-opened
        ...
        <div
            v-if="mode === 'normal' && routerStore.leftMenu.length > 0"
            class="gui-aside-left relative h-full bg-white text-slate-700 dark:text-slate-300 dark:bg-slate-900 border-r shadow dark:shadow-gray-700"
