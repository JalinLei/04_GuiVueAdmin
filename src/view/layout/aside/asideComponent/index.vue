<template>
    <component
        ...
        :is-ctrl-height="isCtrlHeight"
        :is-show-icon="isShowIcon"
    >
        <template v-if="routerInfo.children && routerInfo.children.length">
            <AsideComponent v-for="item in routerInfo.children" :key="item.name" :router-info="item" :is-ctrl-height="isCtrlHeight" :is-show-icon="isShowIcon" />
        </template>
    </component>
</template>
