...
<script setup name="GuiProTable">
    import { computed, onMounted, onUnmounted, provide, reactive, ref, unref, watch, nextTick } from 'vue'
    import { ElTable } from 'element-plus'
    import { useTable } from '@/hooks'
    import { useSelection } from '@/hooks'
    import { DCaret, Operation, Refresh, Search, Share } from '@element-plus/icons-vue'
    import { generateUUID, handleProp, hasTreeStructure } from '@/utils/modules/components'
    import GuiSearchForm from '@/components/GuiSearchForm/index.vue'
    ...
    const props = defineProps({
        ...
        searchCol: { type: [Number, Object], default: () => ({ xs: 1, sm: 4, md: 4, lg: 5, xl: 6 }) }, // 搜索栏每行显示个数
